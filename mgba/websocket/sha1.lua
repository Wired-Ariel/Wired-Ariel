-- SHA-1 e HMAC-SHA1 in puro Lua. Copyright 2009 Jeffrey Friedl - https://regex.info/blog/lua/sha1
-- L'autore: "Feel free to use it as you like"; ridistribuito poi sotto MIT. Vedi THIRD_PARTY_NOTICES.md.
