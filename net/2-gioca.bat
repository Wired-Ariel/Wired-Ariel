...
rem
rem Stanza 58243. Il PEER-ID va chiesto perche' DEVE essere diverso da quello
...
if "%PEER%"=="" set PEER=1
python client.py --transport usb --room 58243 --peer-id %PEER% --usb-timing 7400 --relay 127.0.0.1:9000
pause
